...
This branch moves the frontend deployment source of truth from Vercel-era assumptions to Cloudflare without changing UI, application routing code, business logic, or Supabase schema.

## Deployment Inventory

- **Vercel:** No active `vercel.json` or `.vercel/` production configuration is required.
